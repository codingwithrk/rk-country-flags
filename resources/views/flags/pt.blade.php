<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="rk-country-flags-pt" viewBox="0 0 512 512" width="{{ $width }}" height="{{ $height }}" class="{{ $class }}">
  ...
  <g transform="translate(-68.3 28.4)scale(1.13778)">
    ...
    <g id="rk-pt-e">
      <g id="rk-rk-pt-d" fill="#ff0" stroke="#000" stroke-width=".5">
        ...
        <path id="rk-pt-a" d="M191 141.6v3.4h-4v-3.4z"/>
        <use xlink:href="#rk-pt-a" width="100%" height="100%" x="10.6"/>
        <path id="rk-pt-b" d="M186.3 139h1.2v1h.9v-1h1.2v1h.9v-1h1.2v2c0 .4-.2.6-.5.6h-4.3a.6.6 0 0 1-.6-.6z"/>
        <use xlink:href="#rk-pt-b" width="100%" height="100%" x="10.6"/>
        <path fill="#000001" stroke="none" d="M193.9 140.6c0-.6.9-.6.9 0v1.6h-.9z"/>
        <path id="rk-pt-c" fill="#000001" stroke="none" d="M188.6 142.8c0-.6.8-.6.8 0v1.2h-.8z"/>
        <use xlink:href="#rk-pt-c" width="100%" height="100%" x="10.6"/>
      </g>
      <use xlink:href="#rk-rk-pt-d" width="100%" height="100%" y="46.3"/>
      <use xlink:href="#rk-rk-pt-d" width="100%" height="100%" transform="rotate(-45.2 312.8 180)"/>
    </g>
    <use xlink:href="#rk-rk-pt-d" width="100%" height="100%" x="45.7"/>
    <use xlink:href="#rk-pt-e" width="100%" height="100%" transform="matrix(-1 0 0 1 479.8 0)"/>
    <g id="rk-pt-f" fill="#fff">
    ...
    <use xlink:href="#rk-pt-f" width="100%" height="100%" y="-26"/>
    <use xlink:href="#rk-pt-f" width="100%" height="100%" x="-20.8"/>
    <use xlink:href="#rk-pt-f" width="100%" height="100%" x="20.8"/>
    <use xlink:href="#rk-pt-f" width="100%" height="100%" y="25.8"/>
  </g>
</svg>
