<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="rk-country-flags-mo" viewBox="0 0 512 512" width="{{ $width }}" height="{{ $height }}" class="{{ $class }}">
  ...
  <use xlink:href="#rk-mo-a" width="100%" height="100%" transform="matrix(-1 0 0 1 512 0)"/>
</svg>
