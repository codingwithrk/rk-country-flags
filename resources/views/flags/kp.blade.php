<svg xmlns="http://www.w3.org/2000/svg" id="rk-country-flags-kp" viewBox="0 0 512 512" width="{{ $width }}" height="{{ $height }}" class="{{ $class }}">
  <defs>
    <clipPath id="rk-kp-a">
      <path fill-opacity=".7" d="M92.2 7.8h593.6v485.5H92.2z"/>
    </clipPath>
  </defs>
  <g fill-rule="evenodd" clip-path="url(#rk-kp-a)" transform="matrix(.86254 0 0 1.0546 -79.5 -8.3)">
