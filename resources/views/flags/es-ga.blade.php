<svg xmlns="http://www.w3.org/2000/svg" id="rk-country-flags-es-ga" viewBox="0 0 512 512" width="{{ $width }}" height="{{ $height }}" class="{{ $class }}">
  <g font-size="12">
