<svg xmlns="http://www.w3.org/2000/svg" id="rk-country-flags-ug" viewBox="0 0 512 512" width="{{ $width }}" height="{{ $height }}" class="{{ $class }}">
  <defs>
    <clipPath id="rk-ug-a">
      <path fill-opacity=".7" d="M124 0h496v496H124z"/>
    </clipPath>
  </defs>
  <g clip-path="url(#rk-ug-a)" transform="translate(-128)scale(1.0321)">
