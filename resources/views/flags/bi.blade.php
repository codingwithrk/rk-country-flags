<svg xmlns="http://www.w3.org/2000/svg" id="rk-country-flags-bi" viewBox="0 0 512 512" width="{{ $width }}" height="{{ $height }}" class="{{ $class }}">
  <defs>
    <clipPath id="rk-bi-a">
      <path fill="gray" d="M60.8 337h175v175h-175z"/>
    </clipPath>
  </defs>
  <g fill-rule="evenodd" clip-path="url(#rk-bi-a)" transform="translate(-178 -986)scale(2.9257)">
