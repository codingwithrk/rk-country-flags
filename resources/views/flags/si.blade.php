<svg xmlns="http://www.w3.org/2000/svg" id="rk-country-flags-si" viewBox="0 0 512 512" width="{{ $width }}" height="{{ $height }}" class="{{ $class }}">
  <defs>
    <clipPath id="rk-si-a">
      <path fill-opacity=".7" d="M60.2 0h497.3v497.3H60.2z"/>
    </clipPath>
  </defs>
  <g fill-rule="evenodd" stroke-width="1pt" clip-path="url(#rk-si-a)" transform="translate(-62)scale(1.0295)">
