<svg xmlns="http://www.w3.org/2000/svg" id="rk-country-flags-nr" viewBox="0 0 512 512" width="{{ $width }}" height="{{ $height }}" class="{{ $class }}">
  <defs>
    <clipPath id="rk-nr-a">
      <path fill-opacity=".7" d="M135.6 0h496.1v496h-496z"/>
    </clipPath>
  </defs>
  <g fill-rule="evenodd" stroke-width="1pt" clip-path="url(#rk-nr-a)" transform="translate(-140)scale(1.0321)">
