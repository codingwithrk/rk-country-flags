<svg xmlns="http://www.w3.org/2000/svg" id="rk-country-flags-ps" viewBox="0 0 512 512" width="{{ $width }}" height="{{ $height }}" class="{{ $class }}">
  <defs>
    <clipPath id="rk-ps-a">
      <path fill-opacity=".7" d="M237.1 0h493.5v493.5H237.1z"/>
    </clipPath>
  </defs>
  <g clip-path="url(#rk-ps-a)" transform="translate(-246)scale(1.0375)">
