<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="rk-country-flags-gb-nir" viewBox="0 0 512 512" width="{{ $width }}" height="{{ $height }}" class="{{ $class }}">
  <path fill="#fff" d="M0 0h512v512H0z"/>
  <rect fill="#fff" fill-rule="evenodd" rx="0" ry="0"/>
  <rect id="rk-gb-nir-a" width="512" height="102.4" y="204.8" fill="#c00" fill-rule="evenodd" rx="0" ry="0"/>
  <use xlink:href="#rk-gb-nir-a" width="600" height="300" transform="matrix(0 1 -.9375 0 496 0)"/>
