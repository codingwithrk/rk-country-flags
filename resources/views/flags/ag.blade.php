<svg xmlns="http://www.w3.org/2000/svg" id="rk-country-flags-ag" viewBox="0 0 512 512" width="{{ $width }}" height="{{ $height }}" class="{{ $class }}">
  <defs>
    <clipPath id="rk-ag-a">
      <path fill="#25ff01" d="M109 47.6h464.8v464.9H109z"/>
    </clipPath>
  </defs>
  <g fill-rule="evenodd" clip-path="url(#rk-ag-a)" transform="translate(-120 -52.4)scale(1.1014)">
