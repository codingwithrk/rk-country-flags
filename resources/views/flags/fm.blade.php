<svg xmlns="http://www.w3.org/2000/svg" id="rk-country-flags-fm" viewBox="0 0 512 512" width="{{ $width }}" height="{{ $height }}" class="{{ $class }}">
  <defs>
    <clipPath id="rk-fm-a">
      <path fill-opacity=".7" d="M244.2 0h496v496h-496z"/>
    </clipPath>
  </defs>
  <g fill-rule="evenodd" stroke-width="1pt" clip-path="url(#rk-fm-a)" transform="translate(-252)scale(1.032)">
