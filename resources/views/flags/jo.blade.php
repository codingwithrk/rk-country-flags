<svg xmlns="http://www.w3.org/2000/svg" id="rk-country-flags-jo" viewBox="0 0 512 512" width="{{ $width }}" height="{{ $height }}" class="{{ $class }}">
  <defs>
    <clipPath id="rk-jo-a">
      <path fill-opacity=".7" d="M113.6 0H607v493.5H113.6z"/>
    </clipPath>
  </defs>
  <g clip-path="url(#rk-jo-a)" transform="translate(-117.8)scale(1.0375)">
