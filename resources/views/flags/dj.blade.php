<svg xmlns="http://www.w3.org/2000/svg" id="rk-country-flags-dj" viewBox="0 0 512 512" width="{{ $width }}" height="{{ $height }}" class="{{ $class }}">
  <defs>
    <clipPath id="rk-dj-a">
      <path fill-opacity=".7" d="M55.4 0H764v708.7H55.4z"/>
    </clipPath>
  </defs>
  <g fill-rule="evenodd" clip-path="url(#rk-dj-a)" transform="translate(-40)scale(.722)">
