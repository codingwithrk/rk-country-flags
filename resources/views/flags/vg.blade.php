<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="rk-country-flags-vg" viewBox="0 0 512 512" width="{{ $width }}" height="{{ $height }}" class="{{ $class }}">
  <defs>
    <linearGradient id="rk-vg-a" x1="103.1" x2="92.6" y1="111.3" y2="107.8" gradientTransform="matrix(.99614 0 0 2.25255 703.8 -75)" gradientUnits="userSpaceOnUse">
  ...
  <g transform="translate(-282.6 18.3)scale(.73883)">
    ...
    <g id="rk-vg-b" fill="#ffc72c" stroke="#000" stroke-width=".9">
      ...
      <path fill="url(#rk-vg-a)" d="M809.6 181.8c.6-3.2 1.9-3.8 3.2-8 .2-4-3.2-3.5-2.2-6 1.8-2.9.9-5.6-2.5-7.7.7 3.7-4.4 7.2-4.4 10.2 0 3 2.6 2.4 2.3 7 .2 2.6-.7 2-1 4.5z"/>
      <path d="M831.5 161.7a2.6 2.6 0 1 1-5.2 0 2.6 2.6 0 0 1 5.2 0z"/>
    </g>
    <use xlink:href="#rk-vg-b" width="100%" height="100%" x="-.8" y="41.3"/>
    <use xlink:href="#rk-vg-b" width="100%" height="100%" x="-1.1" y="82"/>
    <use xlink:href="#rk-vg-b" width="100%" height="100%" x="25.6" y="126.1"/>
    <use xlink:href="#rk-vg-b" width="100%" height="100%" x="-4.6" y="162.2"/>
    <use xlink:href="#rk-vg-b" width="100%" height="100%" x="-3.8" y="204.8"/>
    <use xlink:href="#rk-vg-b" width="100%" height="100%" x="146.3" y=".7"/>
    <use xlink:href="#rk-vg-b" width="100%" height="100%" x="144.9" y="41.2"/>
    <use xlink:href="#rk-vg-b" width="100%" height="100%" x="143.1" y="82.7"/>
    <use xlink:href="#rk-vg-b" width="100%" height="100%" x="145.2" y="123.4"/>
    <use xlink:href="#rk-vg-b" width="100%" height="100%" x="144.7" y="164.2"/>
    <use xlink:href="#rk-vg-b" width="100%" height="100%" x="144.9" y="205.2"/>
