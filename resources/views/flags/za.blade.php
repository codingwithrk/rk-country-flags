<svg xmlns="http://www.w3.org/2000/svg" id="rk-country-flags-za" viewBox="0 0 512 512" width="{{ $width }}" height="{{ $height }}" class="{{ $class }}">
  <defs>
    <clipPath id="rk-za-a">
      <path fill-opacity=".7" d="M70.1 0h499.6v499.6H70.1z"/>
    </clipPath>
  </defs>
  <g clip-path="url(#rk-za-a)" transform="translate(-71.9)scale(1.0248)">
