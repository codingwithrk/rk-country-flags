<svg xmlns="http://www.w3.org/2000/svg" id="rk-country-flags-ki" viewBox="0 0 512 512" width="{{ $width }}" height="{{ $height }}" class="{{ $class }}">
  <defs>
    <clipPath id="rk-ki-a">
      <path fill-opacity=".7" d="M161.8 5.8h491.7v491.6H161.8z"/>
    </clipPath>
  </defs>
  <g clip-path="url(#rk-ki-a)" transform="translate(-168.5 -6)scale(1.0413)">
