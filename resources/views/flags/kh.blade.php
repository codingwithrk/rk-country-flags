<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="rk-country-flags-kh" viewBox="0 0 512 512" width="{{ $width }}" height="{{ $height }}" class="{{ $class }}">
  ...
  <g fill="#fff" stroke="#000" transform="translate(6 -556.7)scale(1.28)">
    ...
    <use xlink:href="#rk-kh-a" width="100%" height="100%" transform="matrix(-1 0 0 1 390.7 0)"/>
