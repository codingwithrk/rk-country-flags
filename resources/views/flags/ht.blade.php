<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="rk-country-flags-ht" viewBox="0 0 512 512" width="{{ $width }}" height="{{ $height }}" class="{{ $class }}">
  ...
  <g fill="#f1b517" stroke="#000" stroke-width=".2">
    ...
    <g transform="translate(-170.7)scale(1.70667)">
      ...
      <use xlink:href="#rk-ht-a" width="100%" height="100%" transform="matrix(-1 0 0 1 499.9 0)"/>
    </g>
    <g transform="translate(-170.7)scale(1.70667)">
      <path fill="#016a16" stroke="#016a16" d="m248.8 125.6-.5 9h2.9l-.4-9 3-.3-.3-3.6-7.5.3v3.2z"/>
      <g id="rk-ht-b" fill="#016a16">
      ...
      <use xlink:href="#rk-ht-b" width="100%" height="100%" transform="matrix(-1 0 0 1 499.9 0)"/>
    ...
    <g transform="translate(-170.7)scale(1.70667)">
      <use xlink:href="#rk-ht-c" width="100%" height="100%" transform="matrix(1 0 0 -1 0 320.4)"/>
      ...
      <path id="rk-ht-c" fill="#016a16" stroke="#fff" stroke-linecap="round" d="M238.5 160.1c-.2.5-1 .9-2 .9s-1.7-.4-2-.9a.8.8 0 0 0 0 .4c0 .7.9 1.2 2 1.2 1.2 0 2.1-.5 2.1-1.2a.8.8 0 0 0 0-.4z"/>
      <g id="rk-ht-d">
      ...
      <use xlink:href="#rk-ht-d" width="100%" height="100%" transform="matrix(-1 0 0 1 499.9 0)"/>
