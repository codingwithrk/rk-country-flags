<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="rk-country-flags-gi" viewBox="0 0 512 512" width="{{ $width }}" height="{{ $height }}" class="{{ $class }}">
  <path fill="#da000c" d="M0 0h512v512H0z"/>
  <path fill="#fff" d="M0 0h512v343H0z"/>
  <g stroke="#000" transform="matrix(2 0 0 2 -256 0)">
    <g id="rk-gi-a" fill="#da000c" stroke-linecap="square">
    ...
    <use xlink:href="#rk-gi-a" width="100%" height="100%" transform="matrix(-1 0 0 1 512 0)"/>
    <g fill="#f8d80e">
