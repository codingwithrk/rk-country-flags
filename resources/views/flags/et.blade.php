<svg xmlns="http://www.w3.org/2000/svg" id="rk-country-flags-et" viewBox="0 0 512 512" width="{{ $width }}" height="{{ $height }}" class="{{ $class }}">
  <defs>
    <clipPath id="rk-et-a">
      <path fill-opacity=".7" d="M229.3 6.3h489.3v489.3H229.3z"/>
    </clipPath>
  </defs>
  <g fill-rule="evenodd" stroke-width="1pt" clip-path="url(#rk-et-a)" transform="translate(-240 -6.6)scale(1.046)">
