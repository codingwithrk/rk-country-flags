<svg xmlns="http://www.w3.org/2000/svg" id="rk-country-flags-cl" viewBox="0 0 512 512" width="{{ $width }}" height="{{ $height }}" class="{{ $class }}">
  <defs>
    <clipPath id="rk-cl-a">
      <path fill-opacity=".7" d="M0 0h708.7v708.7H0z"/>
    </clipPath>
  </defs>
  <g fill-rule="evenodd" clip-path="url(#rk-cl-a)" transform="scale(.722)">
