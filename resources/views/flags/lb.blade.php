<svg xmlns="http://www.w3.org/2000/svg" id="rk-country-flags-lb" viewBox="0 0 512 512" width="{{ $width }}" height="{{ $height }}" class="{{ $class }}">
  <defs>
    <clipPath id="rk-lb-a">
      <path fill-opacity=".7" d="M124 0h496v496H124z"/>
    </clipPath>
  </defs>
  <g clip-path="url(#rk-lb-a)" transform="translate(-128)scale(1.0321)">
