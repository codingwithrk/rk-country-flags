<svg xmlns="http://www.w3.org/2000/svg" id="rk-country-flags-bs" viewBox="0 0 512 512" width="{{ $width }}" height="{{ $height }}" class="{{ $class }}">
  <defs>
    <clipPath id="rk-bs-a">
      <path fill-opacity=".7" d="M56.6 26.4H537v480.3H56.6z"/>
    </clipPath>
  </defs>
  <g fill-rule="evenodd" clip-path="url(#rk-bs-a)" transform="matrix(1.066 0 0 1.067 -60.4 -28.1)">
