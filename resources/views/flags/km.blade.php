<svg xmlns="http://www.w3.org/2000/svg" id="rk-country-flags-km" viewBox="0 0 512 512" width="{{ $width }}" height="{{ $height }}" class="{{ $class }}">
  <defs>
    <clipPath id="rk-km-a">
      <path fill-opacity=".7" d="M0 0h416.3v416.3H0z"/>
    </clipPath>
  </defs>
  <g fill-rule="evenodd" clip-path="url(#rk-km-a)" transform="scale(1.23)">
