<svg xmlns="http://www.w3.org/2000/svg" id="rk-country-flags-mz" viewBox="0 0 512 512" width="{{ $width }}" height="{{ $height }}" class="{{ $class }}">
  <defs>
    <clipPath id="rk-mz-a">
      <path fill-opacity=".7" d="M0 0h496v496H0z"/>
    </clipPath>
  </defs>
  <g clip-path="url(#rk-mz-a)" transform="scale(1.0321)">
