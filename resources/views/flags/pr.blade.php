<svg xmlns="http://www.w3.org/2000/svg" id="rk-country-flags-pr" viewBox="0 0 512 512" width="{{ $width }}" height="{{ $height }}" class="{{ $class }}">
  <defs>
    <clipPath id="rk-pr-a">
      <path fill-opacity=".7" d="M51.6 0h708.7v708.7H51.6z"/>
    </clipPath>
  </defs>
  <g fill-rule="evenodd" clip-path="url(#rk-pr-a)" transform="translate(-37.3)scale(.72249)">
