<svg xmlns="http://www.w3.org/2000/svg" id="rk-country-flags-pg" viewBox="0 0 512 512" width="{{ $width }}" height="{{ $height }}" class="{{ $class }}">
  <defs>
    <clipPath id="rk-pg-a">
      <path fill-opacity=".7" d="M81.4 0h496v496h-496z"/>
    </clipPath>
  </defs>
  <g clip-path="url(#rk-pg-a)" transform="translate(-84)scale(1.0321)">
    <g fill-rule="evenodd">
