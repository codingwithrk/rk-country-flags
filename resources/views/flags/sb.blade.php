<svg xmlns="http://www.w3.org/2000/svg" id="rk-country-flags-sb" viewBox="0 0 512 512" width="{{ $width }}" height="{{ $height }}" class="{{ $class }}">
  <defs>
    <clipPath id="rk-sb-a">
      <path fill-opacity=".7" d="M0 0h496v496H0z"/>
    </clipPath>
  </defs>
  <g fill-rule="evenodd" stroke-width="1pt" clip-path="url(#rk-sb-a)" transform="scale(1.0321)">
