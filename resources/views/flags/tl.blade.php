<svg xmlns="http://www.w3.org/2000/svg" id="rk-country-flags-tl" viewBox="0 0 512 512" width="{{ $width }}" height="{{ $height }}" class="{{ $class }}">
  <defs>
    <clipPath id="rk-tl-a">
      <path fill-opacity=".7" d="M0 0h496v496H0z"/>
    </clipPath>
  </defs>
  <g fill-rule="evenodd" clip-path="url(#rk-tl-a)" transform="scale(1.0321)">
