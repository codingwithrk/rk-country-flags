<svg xmlns="http://www.w3.org/2000/svg" id="rk-country-flags-ir" viewBox="0 0 512 512" width="{{ $width }}" height="{{ $height }}" class="{{ $class }}">
  <defs>
    <clipPath id="rk-ir-a">
      <path fill-opacity=".7" d="M186 0h496v496H186z"/>
    </clipPath>
  </defs>
  <g fill-rule="evenodd" clip-path="url(#rk-ir-a)" transform="translate(-192)scale(1.0321)">
