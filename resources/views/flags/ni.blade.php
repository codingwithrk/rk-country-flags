<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="rk-country-flags-ni" viewBox="0 0 512 512" width="{{ $width }}" height="{{ $height }}" class="{{ $class }}">
  <defs>
    <linearGradient id="rk-ni-f" x1="498.7" x2="500.6" y1="289.1" y2="283.4" gradientUnits="userSpaceOnUse">
      <stop offset="0" stop-color="#510000"/>
      <stop offset=".3" stop-color="#8a0000"/>
      <stop offset="1" stop-color="#a00"/>
    </linearGradient>
    <linearGradient id="rk-ni-g" x1="501.4" x2="502.9" y1="291.4" y2="287.4" gradientUnits="userSpaceOnUse">
      <stop offset="0" stop-color="#ff2a2a"/>
      <stop offset="1" stop-color="red"/>
    </linearGradient>
    <linearGradient id="rk-ni-b" x1="484.8" x2="484.8" y1="311.7" y2="317.6" gradientUnits="userSpaceOnUse">
      <stop offset="0" stop-color="#F5F549"/>
      <stop offset="1" stop-color="#97C924"/>
    </linearGradient>
    <linearGradient id="rk-ni-a">
      <stop offset="0" stop-color="#025"/>
      <stop offset=".5" stop-color="#04a"/>
      <stop offset="1" stop-color="#025"/>
    </linearGradient>
    <linearGradient xlink:href="#rk-ni-a" id="rk-ni-h" x1="444.5" x2="634.4" y1="317.5" y2="317.5" gradientUnits="userSpaceOnUse"/>
    <linearGradient xlink:href="#rk-ni-b" id="rk-ni-v" x1="484.8" x2="484.8" y1="311.7" y2="317.6" gradientUnits="userSpaceOnUse"/>
    <linearGradient xlink:href="#rk-ni-a" id="rk-ni-o" x1="444.5" x2="634.4" y1="317.5" y2="317.5" gradientUnits="userSpaceOnUse"/>
    <linearGradient xlink:href="#rk-ni-a" id="rk-ni-p" x1="444.5" x2="634.4" y1="317.5" y2="317.5" gradientUnits="userSpaceOnUse"/>
    <linearGradient xlink:href="#rk-ni-a" id="rk-ni-q" x1="444.5" x2="634.4" y1="317.5" y2="317.5" gradientUnits="userSpaceOnUse"/>
    <linearGradient xlink:href="#rk-ni-a" id="rk-ni-r" x1="444.5" x2="634.4" y1="317.5" y2="317.5" gradientUnits="userSpaceOnUse"/>
    <linearGradient xlink:href="#rk-ni-b" id="rk-ni-u" x1="484.8" x2="484.8" y1="311.7" y2="317.6" gradientUnits="userSpaceOnUse"/>
    <linearGradient xlink:href="#rk-ni-a" id="rk-ni-x" x1="98.9" x2="125" y1="1440.2" y2="1440.2" gradientTransform="scale(4.45715 .22436)" gradientUnits="userSpaceOnUse"/>
    <linearGradient xlink:href="#rk-ni-a" id="rk-ni-j" x1="444.5" x2="634.4" y1="317.5" y2="317.5" gradientUnits="userSpaceOnUse"/>
    <linearGradient xlink:href="#rk-ni-a" id="rk-ni-l" x1="444.5" x2="634.4" y1="317.5" y2="317.5" gradientUnits="userSpaceOnUse"/>
    <linearGradient xlink:href="#rk-ni-a" id="rk-ni-m" x1="444.5" x2="634.4" y1="317.5" y2="317.5" gradientUnits="userSpaceOnUse"/>
    <linearGradient xlink:href="#rk-ni-a" id="rk-ni-i" x1="444.5" x2="634.4" y1="317.5" y2="317.5" gradientUnits="userSpaceOnUse"/>
    <linearGradient xlink:href="#rk-ni-b" id="rk-ni-s" x1="484.8" x2="484.8" y1="311.7" y2="317.6" gradientUnits="userSpaceOnUse"/>
    <linearGradient xlink:href="#rk-ni-a" id="rk-ni-y" x1="47.9" x2="61.7" y1="3054.2" y2="3054.2" gradientTransform="scale(9.12405 .1096)" gradientUnits="userSpaceOnUse"/>
    <clipPath id="rk-ni-c">
  ...
  <g clip-path="url(#rk-ni-c)" transform="translate(-170.7)scale(.85333)">
    ...
    <g id="rk-ni-e">
      ...
      <use xlink:href="#rk-ni-d" width="100%" height="100%" transform="rotate(72 500 285.5)"/>
      <use xlink:href="#rk-ni-d" width="100%" height="100%" transform="rotate(144 500 285.5)"/>
      <use xlink:href="#rk-ni-d" width="100%" height="100%" transform="rotate(-144 500 285.5)"/>
      <use xlink:href="#rk-ni-d" width="100%" height="100%" transform="rotate(-72 500 285.5)"/>
    </g>
    <use xlink:href="#rk-ni-e" width="100%" height="100%" transform="rotate(8 500 285.5)"/>
    <use xlink:href="#rk-ni-e" width="100%" height="100%" transform="rotate(16 500 285.5)"/>
    <use xlink:href="#rk-ni-e" width="100%" height="100%" transform="rotate(24 500 285.5)"/>
    <use xlink:href="#rk-ni-e" width="100%" height="100%" transform="rotate(32 500 285.5)"/>
    <use xlink:href="#rk-ni-e" width="100%" height="100%" transform="rotate(40 500 285.5)"/>
    <use xlink:href="#rk-ni-e" width="100%" height="100%" transform="rotate(48 500 285.5)"/>
    <use xlink:href="#rk-ni-e" width="100%" height="100%" transform="rotate(56 500 285.5)"/>
    <use xlink:href="#rk-ni-e" width="100%" height="100%" transform="rotate(64 500 285.5)"/>
    ...
    <path fill="url(#rk-ni-f)" d="M497 282.6c-1.2.4-1 1-1.6 1.5.2.1.8.3 1.4-.3.2-.2.5-.3.7-.3l-.7.7a5.2 5.2 0 0 0-1.4 1.8c-.3.8-.4 1.7-.3 1.8 0 0 .4.8 1.5 1.2 2 .8 2.4 2.5 4.5 2.5 1.6 0 1.4-1.1 2.7-.9 1 .2 1.7-.7.6-1.2a14 14 0 0 0-5.4 0c-.4-4 0-2.6-.1-4.4-.1-1.7-.7-1.8 0-3.3-.5 1-1.2.8-2 .8z"/>
    ...
    <path fill="url(#rk-ni-g)" d="m501.3 287.4-2-.7c-1.3-.4-2.6-1.2-3.5-.8-.3.1-.3.4-.4.9 0 .5-.5 1.3 0 1 .6-.4 2.4.8 3 1.1.3.2 1 .6 1.1 1 .2.6 0 1.8 0 2.4 0 .5.2 1.8.7 2 .6.1 1.1-.4 1.3-1.3.3-.9.4-1.4.8-1.9s.8-.8 1.3-.9c.6 0 1.4.5 1.4-.2 0-.4-.4-.8-.2-1.4.1-.5-.4-.4-.9-.6z"/>
    ...
    <g fill="url(#rk-ni-h)">
      ...
      <g id="rk-ni-n" fill="url(#rk-ni-i)">
        <path id="rk-ni-k" fill="url(#rk-ni-j)" d="M449.7 321.4a36 36 0 0 0-4.7.3l-.5.9c2.4-.3 4.7-.7 7.2-.7 3.2 0 6.2.8 9.7.8h4.6c3.5 0 6.4-.8 9.7-.8 3.3 0 6.3.8 9.8.8h4.6c3.5 0 6.4-.8 9.7-.8 3.3 0 6.3.8 9.8.8h4.5c3.5 0 6.5-.8 9.8-.8 3.3 0 6.3.8 9.8.8h4.5c3.5 0 6.5-.8 9.8-.8 2.6 0 5 .5 7.5.7l-.5-1a38 38 0 0 0-4.4-.2h-4.5c-3.5 0-6.5.7-9.8.8-3.3 0-6.3-.8-9.8-.8H522c-3.5 0-6.5.7-9.8.8-3.3 0-6.3-.8-9.8-.8H498c-3.5 0-6.5.7-9.8.8-3.3 0-6.3-.8-9.8-.8h-4.5c-3.5 0-6.5.7-9.8.8-3.3 0-6.2-.8-9.7-.8z"/>
        <use xlink:href="#rk-ni-k" width="100%" height="100%" y="-1.1" fill="url(#rk-ni-l)"/>
        <use xlink:href="#rk-ni-k" width="100%" height="100%" y="-2.2" fill="url(#rk-ni-m)"/>
      </g>
      <use xlink:href="#rk-ni-n" width="100%" height="100%" y="-3.3" fill="url(#rk-ni-o)"/>
      <use xlink:href="#rk-ni-n" width="100%" height="100%" y="-6.7" fill="url(#rk-ni-p)"/>
      <path fill="url(#rk-ni-q)" d="M453.2 307.5v.2h93.7l-.1-.2zm-.2.3-.1.3H547l-.1-.3h-94zm-.2.4-.2.3h94.8l-.2-.3zm-.3.5-.3.5h95.6l-.3-.5zm-.4.7-.3.5h96.4l-.3-.5zm-.4.7-.2.4h97l-.2-.4zm-.4.7-.2.4H549l-.3-.4zm-.4.7-.3.6h98.8l-.3-.6H451z"/>
      <path fill="url(#rk-ni-r)" d="M457.4 312.3c3.4.7 3.7 0 3.7 0zm81.5 0s.3.7 3.7 0z"/>
    </g>
    <g fill="#ccd11e">
      <g id="rk-ni-t">
        <path fill="url(#rk-ni-s)" d="M530.6 297c-1.7 0-2.2.9-2.2.9-2.7 10.6-11.8 21.3-22.6 21.3h-8V330h61.4l-6.2-11c-9.7-1.4-17.6-11.3-20.1-21.1 0 0-.6-.9-2.3-.9"/>
      ...
      <use xlink:href="#rk-ni-t" width="100%" height="100%" x="-15.3"/>
      <g fill="#c6cb24">
        <path fill="url(#rk-ni-u)" d="M502.2 298c2.8 10.5 11.8 21.2 22.6 21.2h8.1V330h-65.8v-10.8h8c10.8 0 19.9-10.7 22.6-21.3 0 0 .6-.8 2.3-.8 1.7 0 2.2.8 2.2.8z"/>
      ...
      <g id="rk-ni-w">
        <path fill="url(#rk-ni-v)" d="M484.8 297c-1.8 0-2.3.9-2.3.9-2.5 9.8-11.8 22.3-21.5 23.8l-4.8 8.3h49v-11.3c-8.8-2.4-15.9-11.7-18.2-20.8 0 0-.5-.8-2.3-.8z"/>
      ...
      <use xlink:href="#rk-ni-w" width="100%" height="100%" x="-15.4" fill="#c6cb24"/>
    </g>
