<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="rk-country-flags-cx" viewBox="0 0 512 512" width="{{ $width }}" height="{{ $height }}" class="{{ $class }}">
  ...
  <g fill="#fff" transform="translate(-11.8 182.4)scale(.68267)">
    <path id="rk-cx-a" d="m188.2 191-12.8-12-12.9 11.8 1.4-17.4-17.3-2.8 14.5-9.8-8.6-15.2 16.7 5.3 6.5-16.2L182 151l16.7-5-8.8 15 14.4 10-17.3 2.5z"/>
    <path d="m233.4 335.5-13.8-9.1-13.4 9.6 4.8-15.5-13.6-9.5 16.6-.4 5-15.5 5.6 15.3 16.7-.1L228 320l5.3 15.4z"/>
    <use xlink:href="#rk-cx-a" width="100%" height="100%" x="2.5" y="269.1"/>
    <use xlink:href="#rk-cx-a" width="100%" height="100%" x="-112.1" y="123.2"/>
    <use xlink:href="#rk-cx-a" width="100%" height="100%" x="108.4" y="85"/>
  </g>
</svg>
