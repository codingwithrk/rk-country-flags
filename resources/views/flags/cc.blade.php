<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="rk-country-flags-cc" viewBox="0 0 512 512" width="{{ $width }}" height="{{ $height }}" class="{{ $class }}">
  <defs>
    <path id="rk-cc-a" d="m0-360 69.4 215.8 212-80.3L156-35.6 351 80.1 125 99.8l31.1 224.6L0 160l-156.2 164.3 31.1-224.5L-351 80l195-115.7-125.5-188.9 212 80.3z"/>
    <path id="rk-cc-b" d="M0-210 54.9-75.5l144.8 10.6-111 93.8 34.7 141L0 93.3-123.4 170l34.6-141-111-93.8 145-10.6z"/>
  </defs>
  ...
  <g fill="#ffe000" transform="translate(-25.8 103.5)scale(.05833)">
    <use xlink:href="#rk-cc-a" width="100%" height="100%" x="7560" y="4200"/>
    <use xlink:href="#rk-cc-a" width="100%" height="100%" x="6300" y="2205"/>
    <use xlink:href="#rk-cc-a" width="100%" height="100%" x="7560" y="840"/>
    <use xlink:href="#rk-cc-a" width="100%" height="100%" x="8680" y="1869"/>
    <use xlink:href="#rk-cc-b" width="100%" height="100%" x="8064" y="2730"/>
  </g>
</svg>
