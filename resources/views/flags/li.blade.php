<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="rk-country-flags-li" viewBox="0 0 512 512" width="{{ $width }}" height="{{ $height }}" class="{{ $class }}">
  ...
  <g fill="#ffd83d" stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" transform="translate(-54)scale(.85333)">
    ...
    <use xlink:href="#rk-li-a" width="100%" height="100%" transform="matrix(-1 0 0 1 444 0)"/>
