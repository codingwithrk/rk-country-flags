<svg xmlns="http://www.w3.org/2000/svg" id="rk-country-flags-tz" viewBox="0 0 512 512" width="{{ $width }}" height="{{ $height }}" class="{{ $class }}">
  <defs>
    <clipPath id="rk-tz-a">
      <path fill-opacity=".7" d="M102.9 0h496v496H103z"/>
    </clipPath>
  </defs>
  <g clip-path="url(#rk-tz-a)" transform="translate(-106.2)scale(1.0321)">
