<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="rk-country-flags-sz" viewBox="0 0 512 512" width="{{ $width }}" height="{{ $height }}" class="{{ $class }}">
  ...
  <g fill="#ffd900" stroke="#000" transform="translate(-42.4 58.8)scale(.98607)">
    ...
    <use xlink:href="#rk-sz-a" width="100%" height="100%" x="-23.3" y="17.1"/>
  ...
  <g stroke="#fff" transform="translate(-42.4 58.8)scale(.98607)">
    <g id="rk-sz-d" stroke-width="6.9">
      <g id="rk-sz-c">
        <path id="rk-sz-b" d="M214 192.4v-22.9m13.8 0v22.9m13.8-22.9v22.9"/>
        <use xlink:href="#rk-sz-b" width="100%" height="100%" y="38.1"/>
      </g>
      <use xlink:href="#rk-sz-c" width="100%" height="100%" x="41.6"/>
    </g>
  </g>
  <use xlink:href="#rk-sz-d" width="100%" height="100%" x="104.8" stroke="#000" transform="translate(-42.4 58.8)scale(.98607)"/>
  <g fill="#a70000">
