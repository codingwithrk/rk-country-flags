<svg xmlns="http://www.w3.org/2000/svg" id="rk-country-flags-cd" viewBox="0 0 512 512" width="{{ $width }}" height="{{ $height }}" class="{{ $class }}">
  <defs>
    <clipPath id="rk-cd-a">
      <path fill="#fff" d="M0-88h600v600H0z"/>
    </clipPath>
  </defs>
  <g clip-path="url(#rk-cd-a)" transform="translate(0 75.1)scale(.853)">
