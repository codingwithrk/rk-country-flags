<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" id="rk-country-flags-by" viewBox="0 0 512 512" width="{{ $width }}" height="{{ $height }}" class="{{ $class }}">
  <defs>
    <clipPath id="rk-by-a">
      <path d="M0 0h200v608h8v284l-8 8H0Z"/>
    </clipPath>
  </defs>
  <path fill="#ce1720" stroke-width="1.91554" d="M0 0h512v512H0Z"/>
  <g fill="#fff" clip-path="url(#rk-by-a)" transform="matrix(.5625 0 0 .56889 5 0)">
    <g id="rk-by-c">
      <path id="rk-by-b" d="M36 0v14h-9v14H16v16H8v13H-8V24H8V6H-8V0Zm26 77v15h-8v12h-8V92h-8V77h-8V57h8V42h8V30h8v12h8v15h8v20Zm-17-1h10V58H45ZM19 183h8v-18h-8zm54 0h8v-18h-8ZM-8 305H6v13h6v16h9v15h12v-15h9v-16h8v-13H38v-15h21v10h13v17h11v19h-8v14h-7v13h-6v14h-9v12h-7v11h-9v14H24v-15h-9v-14H8v-9H-8v-23H8v-20H-8Z"/>
      <use xlink:href="#rk-by-b" transform="matrix(-1 0 0 1 200 0)"/>
    ...
    <use xlink:href="#rk-by-c" transform="matrix(1 0 0 -1 0 900)"/>
  ...
  <path fill="#007c30" stroke-width="1.7899" d="M117.3 341.3h395V512h-395z"/>
</svg>
