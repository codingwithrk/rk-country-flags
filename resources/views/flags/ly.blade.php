<svg xmlns="http://www.w3.org/2000/svg" id="rk-country-flags-ly" viewBox="0 0 512 512" width="{{ $width }}" height="{{ $height }}" class="{{ $class }}">
  <defs>
    <clipPath id="rk-ly-a">
      <path d="M250 12h500v500H250z"/>
    </clipPath>
  </defs>
  <g clip-path="url(#rk-ly-a)" transform="translate(-256 -12.3)scale(1.024)">
