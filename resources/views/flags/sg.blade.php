<svg xmlns="http://www.w3.org/2000/svg" id="rk-country-flags-sg" viewBox="0 0 512 512" width="{{ $width }}" height="{{ $height }}" class="{{ $class }}">
  <defs>
    <clipPath id="rk-sg-a">
      <path fill-opacity=".7" d="M27.7 0h708.6v708.7H27.7z"/>
    </clipPath>
  </defs>
  <g fill-rule="evenodd" clip-path="url(#rk-sg-a)" transform="translate(-20)scale(.72249)">
