<svg xmlns="http://www.w3.org/2000/svg" id="rk-country-flags-kn" viewBox="0 0 512 512" width="{{ $width }}" height="{{ $height }}" class="{{ $class }}">
  <defs>
    <clipPath id="rk-kn-a">
      <path fill-opacity=".7" d="M151.7-.3h745.1v745H151.7z"/>
    </clipPath>
  </defs>
  <g fill-rule="evenodd" clip-path="url(#rk-kn-a)" transform="translate(-104.2 .2)scale(.68714)">
